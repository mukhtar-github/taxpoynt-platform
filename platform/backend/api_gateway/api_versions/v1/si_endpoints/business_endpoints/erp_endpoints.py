...
ERP_SCHEMA_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    "odoo": {
        ...
        "fields": [
            ...
            {"id": "currency_id.symbol", "name": "Currency Symbol", "type": "string", "required": False, "description": "Symbol associated with the selected currency.", "example": "₦", "category": "amounts"},
