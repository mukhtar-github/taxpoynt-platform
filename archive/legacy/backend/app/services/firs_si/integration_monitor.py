...
from app.services.firs_si.odoo_service import test_odoo_connection
    ...
    while status_key in _monitoring_threads and _monitoring_threads[status_key]["active"]:
        try:
            ...
            if integration.integration_type == IntegrationType.ODOO:
                ...
                from app.services.firs_si.integration_service import decrypt_integration_config
                ...
                from app.services.firs_si.integration_service import test_integration_connection
