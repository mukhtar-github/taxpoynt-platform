"""
FIRS SI Digital Certificate Service

This service implements System Integrator (SI) specific functionality for
digital certificate management and lifecycle operations.

SI Role Responsibilities:
- Digital certificate lifecycle management
- Certificate storage and retrieval for invoice signing
- Certificate validation and verification
- Certificate metadata extraction and management
- Integration with ERP systems for certificate usage
- Authentication of invoice origin using certificates

This service is part of the firs_si package and focuses on the SI's core
responsibility of digital certificate management for invoice authentication.
"""
