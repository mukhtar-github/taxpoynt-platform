...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      // Enhanced touch-friendly spacing and sizing
      minHeight: {
        'touch': '44px', // Minimum touch target size (iOS/Android guidelines)
        'touch-lg': '48px', // Larger touch targets for complex interactions
        'card': '120px', // Minimum card height for mobile
      },
      minWidth: {
        'touch': '44px',
        'touch-lg': '48px',
        'card': '280px', // Minimum card width for responsive grids
      },
