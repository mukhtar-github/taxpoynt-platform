"""
Odoo Invoice Service for integrating UBL mapping with IRN generation workflow.

This module connects the Odoo UBL mapping system with the existing invoice
generation workflow in the TaxPoynt eInvoice system.
"""
...
from app.services.odoo_service import generate_irn_for_odoo_invoice, test_odoo_connection
...
class OdooInvoiceService:
    """
    Service for handling Odoo invoice processing and UBL transformation.
    
    This class integrates the Odoo UBL mapping system with the existing
    invoice generation workflow to provide end-to-end processing.
    """
    ...
    def process_invoice(
        ...
        """
        Process an Odoo invoice: retrieve, map to UBL, validate, and generate IRN.
    ...
    def process_invoices(
        ...
        """
        Process multiple invoices from Odoo within a date range.
        ...
        try:
            ...
            invoices, pagination = connector.get_invoices(
                from_date=from_date,
                to_date=to_date,
    ...
    def test_connection(self, connector_params: Dict[str, str]) -> Dict[str, Any]:
        """
        Test the connection to Odoo and return system information.
    ...
    def _get_connector(self, connector_params: Dict[str, str] = None) -> OdooConnector:
        ...
        connector = OdooConnector(
            ...
            db=connector_params["db"],
            user=connector_params["user"],
